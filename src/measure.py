...
def mouse_callback(event, x, y, flags, param):
    global points, pixels_per_metric, temp_img, unknown_measurements, original_img

    if not is_captured or original_img is None:
        return
        ...
        if len(points) % 2 == 0:
            ...
            if pixels_per_metric is None:
                ...
                try:
                    ...
                    print("Invalid number. Resetting points.")
                    points = points[:-2]
...
if __name__ == "__main__":
    # Standard webcam index is 0. If you have an external cam, it might be 1 or 2.
    camera_index = 0 
    ...
    # Set resolution to 640x480 as per webcam specs
    ...
    while True:
        ...
        if key == ord(' '):
            is_captured = True
            temp_img = original_img.copy()
            points = [] # Clear points for the new capture
